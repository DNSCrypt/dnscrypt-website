    ...
    return {
      ...
      clientImplementations: [
        ...
        },
        {
          ...
          platforms: ["macOS"],
          language: "Shell",
          description: "dnscrypt-proxy switcher is a plugin for BitBar/SwiftBar to control dnscrypt-proxy from the menu bar.",
        },
      ],
      serverHeaders: [
        { text: "Name", value: "name" },
      ...
      serverImplementations: [
        {
          ...
          official: true,
          description:
            "Reference implementation - High-performance DNSCrypt, Anonymized DNSCrypt, and DoH server with built-in caching and metrics. Serves all protocols on the same port.",
        },
        {
          name: "doh-server",
          author: "Frank Denis (@jedisct1)",
        ...
        },
        {
          ...
          language: "C",
          description:
            "Validating, recursive, caching DNS resolver with DNSCrypt support. Widely used in production environments.",
        },
        {
          name: "dnsdist",
          author: "PowerDNS",
